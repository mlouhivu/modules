...
local py_base = '/appl/soft/phys/gpaw/python/3.7.3'
local bundle = '2019-05'

setenv('LIBXCDIR', '/appl/soft/phys/libxc/4.3.4')
...
prepend_path('PYTHONPATH', pathJoin(base, 'lib/python3.7/site-packages'))
