...
load("python/2.7.10-gcc")
load("cython/0.23")

local base = '/homeappl/home/louhivuo/appl_taito/pyMIC-gcc'
...
append_path('PYMIC_LIBRARY_PATH', pathJoin(base, 'pymic'))
append_path('PYMIC_LIBRARY_PATH', pathJoin(base, 'benchmarks'))
append_path('PYMIC_LIBRARY_PATH', pathJoin(base, 'tests'))
append_path('MIC_LD_LIBRARY_PATH', pathJoin(base, 'pymic'))
append_path('LD_LIBRARY_PATH', pathJoin(base, 'pymic'))
